...
// submit
student_controller.post(  "/submit_homework/:sessionId"  , Multer_host( PDFExtension ).single("HomeworkPDF")  , error_handler_middleware(student_service.submit_Homework_Solution_service)  ) 
student_controller.post(  "/submit_section/:sessionId"  , Multer_host( PDFExtension ).single("SectionPDF")  , error_handler_middleware(student_service.upload_Section_Material_service)  ) 
student_controller.post(  "/submit_video_quizzes/:sessionId"  , error_handler_middleware(student_service.submit_VideoQuiz_Answers_service)  ) 
