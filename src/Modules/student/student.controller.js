...
student_controller.get("/get_sessions_list", error_handler_middleware(student_service.getStudentSessions)  ) 
student_controller.get("/get_accessible_session", error_handler_middleware(student_service.getAccessibleSessions)  ) 
