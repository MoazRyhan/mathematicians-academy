...
// CRUD routes
admin_controller.get("/get_admin_date", error_handler_middleware(admin_services.get_admin_service));
admin_controller.put("/updata_admin_date", error_handler_middleware(admin_services.update_admin_service));
...
admin_controller.put("/update-user/:userId", error_handler_middleware(admin_services.update_admin_service));
